...
const AddRecipe = () => {
  ...
  const { handleSubmit, control, register, getValues, reset } = useForm({
    defaultValues: {
      title: "",
      description: "",
  ...
  // Fetch the recipe and prefill the form
  useEffect(() => {
    const fetchRecipe = async () => {
      try {
        ...
        reset({
          ...
          instructions: response.data.instructions || [{ text: "" }],
          cookTime: response.data.cookTime || "",
          tags: response.data.tags || [],
          image: response.data.image || "",
        });
      } catch (error) {
        console.error("Error fetching recipe:", error.response.status);
        setError(error);
      }
    };
